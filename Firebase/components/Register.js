      ...
      <View style={{flex:1, justifyContent: 'center', alignItems: 'center',}}>
          <View>
                ...
                <TextInput  style={{ height: 40, borderBottomColor: '#ccc', borderBottomWidth: 1 }}
                        ...
                        />
                <Btn onPress={this.login} viewStyle={{flex:0, height:50}}><Text>REGISTER</Text></Btn>
                <Btn onPress={this.register} viewStyle={{flex:0,height:50}}><Text>ALREADY HAVE AN ACCOUNT? LOG IN!</Text></Btn>
          </View>
      </View>
    );
  }
