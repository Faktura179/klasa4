    ...
    render() {
        return (
            <View style={styles.container}>
                <View style={[{ flex: 2, backgroundColor: "#f50057" }, styles.header]}>
                    <Text style={[{ fontSize: 30 }, styles.headerTxt, this.state.fontloaded ? styles.txt:null]}>Camera App</Text>
                    <Text style={[{ fontSize: 20 }, styles.headerTxt, this.state.fontloaded ? styles.txt:null]}>Make photos</Text>
                    <Text style={[{ fontSize: 20 }, styles.headerTxt, this.state.fontloaded ? styles.txt:null]}>Show Gallery</Text>
                </View>
